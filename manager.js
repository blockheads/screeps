...
const { ROLE_HARVESTER, ROLE_UPGRADER, ROLE_BUILDER, ROLE_REPAIRER, ROLE_LONG_HARVESTER, ROLE_SCOUT, ROLE_WALL_REPAIRER, 
    ...
    ROLE_SCOUT_PRIORITY, ROLE_WALL_REPAIRER_PRIORITY, ROLE_TRANSPORTER, ROLE_TRANSPORTER_PRIORITY, ROLE_CONTROLLER_TRANSPORTER, ROLE_CONTROLLER_TRANSPORTER_PRIORITY } = require('./util.role');
...
ROLES[ROLE_CONTROLLER_TRANSPORTER] = ['transporter.controller', ROLE_CONTROLLER_TRANSPORTER_PRIORITY];
